...
const StudentArtist1 = ({ onSuccess }: StudentArtist1Props) => {
  const { univEmail, setUnivEmail, univName, setUnivName } =
    useStudentInfoStore();
  ...
  const [certifyEmailError, setCertifyEmailError] = useState<
    string | undefined
  >("");
        ...
        <InputItem>
          ...
          <Box width="100%" display="flex" flexDir="column">
            ...
            <CustomInput
              ...
              value={univEmail}
              onChange={(e) =>
                handleEmailChange(e, setUnivEmail, setIsEmailFormValid)
              }
