export const backgroundImageList: { src: string; creator: string }[] = [
  {
    ...
    creator: "Content Pixie",
  },
  {
    src: "https://images.unsplash.com/photo-1518132977555-6bce51766237?q=80&w=2854&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    creator: "Hamish",
  },
  {
