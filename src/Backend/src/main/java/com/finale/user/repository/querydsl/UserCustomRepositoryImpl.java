package com.finale.user.repository.querydsl;
...
import com.finale.user.entity.QArtistInfo;
import com.finale.user.entity.QSocial;
import com.finale.user.entity.QUser;
